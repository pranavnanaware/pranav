"use client";
import { Github, Mail, PersonStandingIcon, Twitter } from "lucide-react";
...
const socials = [
  {
    ...
    href: "https://twitter.com/pranavnanaware",
    label: "Twitter",
            ...
            <Card>
              ...
              >
                ...
                <div className="z-10 flex flex-col items-center">
                  <span className="lg:text-xl font-medium duration-150 xl:text-xl max-xl:text-xl-2xl text-zinc-200 group-hover:text-white font-display">
                    {s.handle}
                  </span>
